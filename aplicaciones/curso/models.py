...
class Curso(models.Model):
    ...
    nivel = models.CharField(max_length=20, null=False, blank=False, validators=[MinValueValidator(1), MaxValueValidator(10)], help_text='Nivel de la malla curricular (1 a 10).')
